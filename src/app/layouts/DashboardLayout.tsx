...
const menuItems: Record<DashboardRole, MenuItem[]> = {
  admin: [
  ...
  'guru-kelas': [
    { icon: LayoutDashboard, label: 'Dashboard', path: '/guru-kelas' },
    { icon: ClipboardList, label: 'Monitoring Presensi', path: '/guru-kelas/presensi' },
    { icon: FileText, label: 'Rekap Nilai', path: '/guru-kelas/nilai' },
    { icon: BookOpen, label: "Setoran Al-Qur'an", path: '/guru-kelas/quran' },
  ],
  'guru-mapel': [
    { icon: LayoutDashboard, label: 'Dashboard', path: '/guru-mapel' },
    { icon: ClipboardList, label: 'Presensi Kelas', path: '/guru-mapel/presensi' },
    { icon: BarChart3, label: 'Rekap Absensi', path: '/guru-mapel/rekap-absensi' },
    { icon: FileText, label: 'Input Nilai', path: '/guru-mapel/nilai' },
  ],
  siswa: [
        ...
        <div className="flex flex-grow flex-col overflow-y-auto pt-5 pb-4">
          <div className="mb-8 flex items-center gap-3 px-6">
            ...
            <div>
              ...
              <div className="text-xs text-gray-600">{roleNames[role]}</div>
            </div>
          </div>
